...
@Set JDK="C:\Program Files\Java\jdk-13.0.1"
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\OneDrive\\%JAVAPROJ_NAME%
@Set PACKAGE=projeto
@Set PACKAGE_PREFIX=edu.ufp.inf.sd
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd
@Set SERVICE_NAME_ON_REGISTRY=TaskGroupService
@Set CLIENT_CLASS_PREFIX=TaskGroup
@Set SERVER_CLASS_PREFIX=TaskGroup
